...
import TheBigInnerSplashProdScr from './src/screens/TheBigInnerSplashProdScr';
// libs
...
export default function App() {
  ...
  const INITIAL_URL = `https://maple-slate-horizon.space/`;
  const URL_IDENTIFAIRE = `IjFwzxiC`;
  ...
  OneSignal.initialize('45e732f2-d126-4856-9c00-753c4ee6410b');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-03T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="TheBigInnerSplashProdScr"
            component={TheBigInnerSplashProdScr}
  ...
  return (
    <NavigationContainer>
      {!loader ? <SplashScreen /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
}
